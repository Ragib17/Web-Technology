...
if($check == 1){
    header("Location: http://localhost/Project_Mid_Term/AddProduct/form.php?pNumberErr=$pNumberErr&pNameErr=$pNameErr&pPriceErr=$pPriceErr&pDateErr=$pDateErr&eDateErr=$eDateErr&quantityErr=$quantityErr");
}
...
$sql = "INSERT INTO addproduct (pname, pnumber,  pprice,  pdate,  edate, pquantity) VALUES ('$pname', '$pnumber', '$pprice', '$pdate', '$edate', '$quantity')";
